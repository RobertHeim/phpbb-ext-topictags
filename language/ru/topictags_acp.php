...
$lang = array_merge($lang, array(
	...
	'TOPICTAGS_WHITELIST_EXP'					=> 'Pазделяет список разрешенных тегов.<br/>ПРИМЕЧАНИЕ: Теги должны соответствовать регулярным выражениям (автоматическая проверка не выполняется).',
