...
$lang = array_merge($lang, array(
	...
	'TOPICTAGS_WHITELIST_EXP'					=> 'Запятая (,), разделяет список разрешенных тегов.<br/>ПРИМЕЧАНИЕ: Теги должны соответствовать регулярным выражениям (автоматическая проверка не выполняется).',
	...
	'TOPICTAGS_BLACKLIST_EXP'					=> 'Запятая (,), разделяет список запрещенных тегов.<br/>ПРИМЕЧАНИЕ: Все теги, которые не соответствуют регулярным выражением всегда отклоняются.',
	...
	'TOPICTAGS_ALLOWED_TAGS_EXP_FOR_USERS_EXP'	=> 'Этот текст отображается для пользователей и должен объяснить, какие теги разрешены, а какие нет.<br/>По-умолчанию: ' . $lang['ACP_RH_TOPICTAGS_REGEX_EXP_FOR_USERS_DEFAULT'],
